module.exports = function(props) {
  return (
	<div>
		...
		<br /><hr width="85%" class="center-line"/><br />
		<div class="patterns">		
			<img class="patterns-category" src="https://i.ibb.co/RPVTP3n/Amazon-EC2-AMI-light-bg-4x.png" height="25" width="25"/>
			...
			<img class="patterns-category" src="https://i.ibb.co/QX2SybM/AWS-Lambda-light-bg-4x.png" height="25" width="25"/>
			...
			<img class="patterns-category" src="https://i.ibb.co/bR1Dj42/Amazon-Elasti-Cache-4x.png" height="25" width="25"/>
			...
			<img class="patterns-category" src="https://i.ibb.co/mFJwWcW/Amazon-Aurora-light-bg-4x.png" height="25" width="25"/>
			...
			<img class="patterns-category" src="https://i.ibb.co/DVbxDKD/Amazon-S3-Glacier-light-bg-4x.png" height="25" width="25"/>
