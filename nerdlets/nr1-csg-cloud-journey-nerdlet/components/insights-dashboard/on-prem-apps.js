...
export default class InsightsDashboard extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
                  userAppFilter: "",
                  appFilter: "WHERE appName NOT LIKE '%_AWS'"
                 };
  }; //constructor
          ...
          <StackItem className="toolbar-section1">
            ...
            >
              <StackItem className="toolbar-item">
                <TextField onChange={() => this.setState( {userAppFilter: event.target.value} )} style={{width: '600px'}} label="Filter" placeholder="WHERE appName NOT LIKE '%_AWS'" />
              </StackItem>
            </Stack>
          </StackItem>
